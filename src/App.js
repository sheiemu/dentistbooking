...
// 👇 Import the page components from files
import Home from './pages/Home';
import Services from './pages/Services';
...
import Home from './pages/Home';
// Temporary inline component for testing
const TestDoctors = () => <h2>Doctors Inline Component – This Works!</h2>;
...
function App() {
  ...
  //  Don't import Doctors component now
  return (
    <Router>
      <div style={{ display: 'flex' }}>
        <Sidebar />
        <main style={{ padding: '20px', flex: 1 }}>
          <Routes>
            <Route path="/" element={<Home />} />
            <Route path="/services" element={<Services />} />
            <Route path="/doctors" element={<TestDoctors />} />
            <Route path="/reviews" element={<Reviews />} />
            <Route path="/contacts" element={<Contacts />} />
          </Routes>
        </main>
